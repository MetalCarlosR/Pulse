...
public class PulseMal2 : MonoBehaviour
{
    private PlayerControllerMal2 player;
    private int speed;
    ...
    void Start()
    {
        if (GetComponent<PlayerControllerMal2>() && cam != null)
        {
            player = GetComponent<PlayerControllerMal2>();
            speed = player.speed;
